                ...
                <div className=''>
                    ...
                    <div className="grid md:grid-cols-2 gap-4 lg:gap-6">
                        <div className="grid gap-4 lg:gap-6 lg:grid-cols-2">
                            {/*  */}
                            <a href='https://maps.app.goo.gl/D95UqUnZNwDQ9RDx5' target="_blank" className="bg-white space-y-4 shadow-2xl hover:border-zinc-300 rounded-xl font-light shadow-gray-200 border border-zinc-100 p-4 py-8 cursor-pointer transition-all duration-200 ease-in-out">
                            ...
                            {/*  */}
                            <a href='tel:+212684290290' className="bg-white space-y-4 shadow-2xl hover:border-zinc-300 rounded-xl font-light shadow-gray-200 border border-zinc-100 p-4 py-8 cursor-pointer transition-all duration-200 ease-in-out">
                                <div className='flex items-center space-x-1.5'>
                                    <div className='flex'>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" className="size-6">
                            ...
                            {/*  */}
                            <a href='mailto:contact@ebacc.ma' className="bg-white space-y-4 shadow-2xl hover:border-zinc-300 rounded-xl font-light shadow-gray-200 border border-zinc-100 p-4 py-8 cursor-pointer transition-all duration-200 ease-in-out">
                                <div className='flex items-center space-x-1.5'>
                                    <div className='flex'>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" className="size-6">
