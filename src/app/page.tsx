...
export default function Home() {
  return (
    <main className="md:p-16 p-8 flex min-h-screen w-screen flex-col justify-between items-center">
      ...
      <PageWrapper>
        <main className="flex items-center justify-between w-full gap-32 p-8 py-16 group bg-sky-900 rounded-xl text-sky-50">
          <div className="">
          ...
          <div className="">
            <div className="w-64 h-64 rounded-xl relative">
              <Image
                className="absolute hover:scale-105 transition-all duration-300"
                src="/7394943-ai.png"
                alt="Next.js logo"
                width={500}
                height={500}
        ...
        <div>
          <div className="flex flex-row-reverse justify-center items-center p-8 gap-2 bg-sky-900 border border-zinc-800 border-opacity-25 rounded-xl shadow-2xl w-fit m-auto relative -top-16">
            ...
            <button className='p-2 px-4 flex justify-center items-center gap-2 text-sky-50'><h1>Learn More</h1></button>
          </div>
        </div>
      </PageWrapper>
